...
export const reducer = createReducer(
  ...
  on(TransfersActions.reloadTransfers, (state) => ({
    ...state,
    loading: true,
    loaded: false,
    failure: false,
  ...
  on(TransfersActions.reloadTransfersSuccess, (state, { transfers }) =>
  ...
  on(TransfersActions.reloadTransfersFailure, (state, { error }) => ({
    ...state,
    loading: false,
    loaded: true,
    failure: true,
