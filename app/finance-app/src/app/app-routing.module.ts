...
const routes: Routes = [
  { path: '', component: WelcomePageComponent },
  {
    ...
    loadChildren: () => import('./modules/containers/test-page/test-page.module').then((m) => m.TestPageModule),
  },
  {
    path: 'category',
    loadChildren: () => import('./modules/containers/category/category.module').then((m) => m.CategoryModule),
  },
  {
    path: 'account',
