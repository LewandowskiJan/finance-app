...
import { Project } from './../../../app/dictionary/models/project';

const expect = chai.expect;
chai.use(chaiHttp);

describe('POST: /api/dictionary/project/add route to insert data', () => {
  basicSetup();
  it('should create and return a new project item', () => {
    ...
    return (
      chai
        ...
        .then((_res) => {
          ...
          return Project.findById(response.body._id);
        })
