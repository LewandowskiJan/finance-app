...
describe('POST: /api/dictionary/type/add route to insert data', function () {
  basicSetup();
  it('should create and return a new type item', function () {
    let res;
    ...
    return (
      chai
        ...
        .then((_res) => {
          ...
          return Type.findById(res.body._id);
        })
