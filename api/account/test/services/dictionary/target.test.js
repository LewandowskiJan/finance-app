...
describe('POST: /api/dictionary/target/add route to insert data', function () {
  basicSetup();
  it('should create and return a new target item', function () {
    let res;
    ...
    return (
      chai
        ...
        .then((_res) => {
          ...
          return Target.findById(res.body._id);
        })
